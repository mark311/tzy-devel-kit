...
(custom-theme-set-faces
 'zhiyang-v2
 '(default ((t (:inherit nil :stipple nil :background "dark blue" :foreground "wheat" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 140 :width normal :foundry "nil" :family "Monaco"))))
